...
<body>
	...
	<div id="parameterPanel" class="closed">
		<button id="parameterPanelToggle" onclick="toggleParameterPanel()"></button>
		<form id="paramForm">
			...
			<span title="Check if you want to use the JoyCon horizontally">
				<input id="paramHorizontal" type="checkbox">
				<label for="paramHorizontal">Horizontal JoyCon</label>
			</span>
			<span title="Check if you have the left Joycon in use">
				<input id="paramLeftJoycon" type="checkbox">
				<label for="paramLeftJoycon">Left JoyCon</label>
			</span>
			<button type="submit">Apply</button>
		</form>
	</div>
	<div id="stopButton" class="stop" hidden></div>
...
function changeParams(e) {
	...
	localStorage.setItem("isLeftJoycon", isLeftJoycon);
...
function toggleParameterPanel() {
	...
	const toggle = document.getElementById("parameterPanelToggle");
	if (panel.classList.contains("closed")) {
		panel.classList.replace("closed", "opened");
		toggle.innerHTML = "<";
		toggle.title = "Hide parameter panel";
	} else {
		panel.classList.replace("opened", "closed");
		toggle.innerHTML = ">";
		toggle.title = "Show parameter panel";
	}
}
...
#parameterPanel.closed form {
	visibility: hidden;
}

#parameterPanel.opened form {
	visibility: visible;
}
